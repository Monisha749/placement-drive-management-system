...
public class ViewFeedback extends JFrame {
    ...
    public ViewFeedback(){
        ...
        JLabel title = new JLabel("User Feedback", SwingConstants.CENTER);
        ...
        JComboBox<String> filterBox = new JComboBox<>(new String[]{"ID", "Given By", "User ID", "Message", "Date"});
        ...
        model = new DefaultTableModel(
                new String[]{"ID","Given By","User ID","Message","Date"},0
        );
        ...
        exportBtn.addActionListener(e ->
                CsvExportUtil.exportTableToCsv(this, table, "feedback_export")
        );
